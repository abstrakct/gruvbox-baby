...
function M.setup(config)
  ...
  theme.base = {
    ...
    ["@func.builtin"] = { fg = c.light_blue },
    ["@function"] = { fg = c.light_blue, style = config.function_style },
    ["@function.call"] = { fg = c.light_blue, style = config.function_style },
    ["@function.builtin"] = { fg = c.light_blue, style = config.function_style },
